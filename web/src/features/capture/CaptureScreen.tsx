...
import { lookupBarcode, productToKvMap } from '../../services/productLookup';
import type { InputType } from '../../services/historyRepo';
import { fileToDataUrl, downscaleDataUrl } from '../../ui/imageUtils';
  ...
  const process = useCallback(
    async (imageDataUrl: string, inputType: InputType) => {
      ...
      try {
        ...
        const pairs = kvParser.parse({ ocrText, barcode, productFields });
